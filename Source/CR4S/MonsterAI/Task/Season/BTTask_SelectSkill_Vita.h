...
#include "BTTask_SelectSkill_Vita.generated.h"

UCLASS()
class CR4S_API UBTTask_SelectSkill_Vita : public UBTTask_SelectSkill
{
	GENERATED_BODY()

public:
	UBTTask_SelectSkill_Vita();
...
private:
	...
	FString MyHeader = TEXT("Task_SelectSkillVita");
};
